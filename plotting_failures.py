...
for x in range(len(feature_x)):
    for y in range(len(feature_y)):            
        Z[y,x] = save_data[0][f"map_{y+save_data[3]}-agent_{x+save_data[1]}-spawn_{0}"]['failed_perc']
print(Z)
ax1.contourf(X, Y, Z)
...
for x in range(len(feature_x)):
    for y in range(len(feature_y)):            
        Z[y,x] = save_data[0][f"map_{y+save_data[3]}-agent_{x+save_data[1]}-spawn_{1}"]['failed_perc']
print(Z)
ax2.contourf(X, Y, Z)
